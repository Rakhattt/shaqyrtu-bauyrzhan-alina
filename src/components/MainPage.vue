    ...
    <div>
        <div class="blok-1 sitecontainer">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="kurmetti" data-aos="zoom-out-right" data-aos-easing="ease-in-out" data-aos-duration="700">
                            Құрметті қонақтар! 					
                        </h1>
                        <div class="shaktext" data-aos="zoom-out-left" data-aos-easing="ease-in-out" data-aos-duration="800">
                            <p>
                                Сіз(дер)ді <br> Бауыржан мен Алинаның құдалық тойына арналған
                            ...
                            <div class="toi6">
                                <div class="timer">
                                    <div class="timer__items">
                                        <div  data-aos="zoom-out-right" data-aos-easing="ease-in-out" data-aos-duration="700" class="timer__item timer__days" data-title="күн"></div>
                                        <div  data-aos="zoom-out-left" data-aos-easing="ease-in-out" data-aos-duration="700" class="timer__item timer__hours" data-title="сағат"></div>
                                        <div  data-aos="zoom-out-right" data-aos-easing="ease-in-out" data-aos-duration="700" class="timer__item timer__minutes" data-title="минут"></div>
                                        <div  data-aos="zoom-out-left" data-aos-easing="ease-in-out" data-aos-duration="700" class="timer__item timer__seconds" data-title="секунд"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="toi8"></div>
                            <div class="toi9"  data-aos="zoom-out-left" data-aos-easing="ease-in-out" data-aos-duration="700">Тойдың мекен-жайы:</div>
                            <div class="toi10"  data-aos="zoom-out-left" data-aos-easing="ease-in-out" data-aos-duration="700">
                                &ZeroWidthSpace;Астана қаласы, Абылай хан даңғылы 43/2 <br>
                                <span>"Мерей" тойханасы</span><br><br>
                            </div>
                            <a data-aos="zoom-out-up" data-aos-easing="ease-in-out" data-aos-duration="700" target="_blank" href="https://2gis.kz/astana/firm/70000001019489097" class="twogis">Карта арқылы ашу</a>
                        </div>
                    </div>
                </div>
            </div>
...
export default{
    ...
    methods:{
        ...
        sendMessage(payload) {
            const chatId = '529551634 ';
            const message = payload;
            const telegramBotToken = '6147556409:AAGkQnrpnCfuHpNANQOcx5hbQPJuWrKD_0w';
    ...
    mounted(){
        this.$nextTick(() => {
            ...
            const deadline = new Date(2023, 6, -2, 17, 0, 0);
